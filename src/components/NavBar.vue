<template>
  <nav>
    ...
    <router-link :to="{name:'CreateProfile'}" v-if="isLoggedIn"> Create Profile </router-link> |
    <a href="#" @click="logout" v-if="!isLoggedin">Logout</a> -->


<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
           <router-link :to="{name:'Dashboard'}" class="navbar-brand brand-logo" href="index.html"><img src="assets/images/logo.svg" alt="logo">  </router-link >
